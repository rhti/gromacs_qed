                        ...
                        int file_version, real *fudgeQQ)
{
    ...
    if(file_version>=39){
      ...
      gmx_fio_do_real(fio,ir->EMFx);
      gmx_fio_do_real(fio,ir->EMFy);
      gmx_fio_do_real(fio,ir->EMFz);

      gmx_fio_do_real(fio,ir->n_index); /* refractive index */
      gmx_fio_do_real(fio,ir->L); /* cavity length */
      gmx_fio_do_int(fio,ir->n_min); /* integer defining the minimum k=2*Pi*n_min/L_au */
      gmx_fio_do_int(fio,ir->n_max); /* integer defining the maximum k=2*Pi*n_max/L_au */
